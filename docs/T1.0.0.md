...
```json
{
     ...
     "NLog": {
          ...
          "rules": [
                ...
                { "name":"Microsoft.Hosting.Lifetime*", "minlevel":"Info", "writeTo":"ColoredConsole", final:true },
                { "name":"Microsoft.*", "minlevel":"Warn", "writeTo":"ColoredConsole", final:true },

                { "name":"PM2.Exceptions.*", "minlevel":"Info", "writeTo":"ColoredConsole", final:true },
                { "name":"PM2.*", "minlevel":"Info", "writeTo":"ColoredConsole", final:true },

                { "name":"*", "minLevel":"Info", "writeTo":"ColoredConsole" }
