...
### \- 🔸 ${ onexception } [ 条件 ]内部布局 :id=H2_1_3_7
...
### \- 🔸 ${ all-event-properties } 上下文数据 :id=H2_2_3_2
...
### \- 🔸 ${ event-properties } 上下文数据( 单个属性 ) :id=H2_2_3_2
